...
module.exports = {
  VERSION: 'v4.4.4',
  SESSION_ID: process.env.SESSION_ID || 'HP_2024_DEC_8_JGJ33X',
  ...
  BOT_INFO: process.env.BOT_INFO || 'ʜᴇʀᴍɪᴛ;Dev-ixAAr;94754613532;https://i.imgur.com/6oRG106.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || 'ʜᴇʀᴍɪᴛ;Dev-ixAAr;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || 'ʜᴇʀᴍɪᴛ;Dev-ixAAr',
